...
from re_id.generate_detections_static import create_box_encoder
from yolo_v3.yolo_static import YOLO

backend.clear_session()
ap = argparse.ArgumentParser()
ap.add_argument("-i", "--input",help="path to input video", default = "./test_video/MOT16-08-raw.webm")
